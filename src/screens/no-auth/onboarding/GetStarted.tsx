...
export default function GetStarted({ navigation }: Props) {
  ...
  return (
    <View className="flex flex-1 bg-primary-500">
      <StatusBar style={colorScheme === 'dark' ? 'light' : 'dark'} />
      <View className="flex justify-center items-center w-full max-h-[40%]">
        <Image
      ...
      <View className="rounded-t-3xl bg-bg dark:bg-bg-dark flex flex-1 items-center">
